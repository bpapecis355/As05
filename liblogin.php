...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if($data) { // if successful login set session variables
		...
		Database::disconnect();
		header("Location: liblogin.php?id=$sessionid ");
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="liblogin.php" method="post">
			...
			test@test.com
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="password" type="password" placeholder="not a used password, please" required> 
					</div>	
				</div> 
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="clientCreate.php">Join (New Volunteer)</a>
				</div>
				
				
				<footer>
					<small>&copy; Copyright 2020, Bryce Pape
					</small>
				</footer>
